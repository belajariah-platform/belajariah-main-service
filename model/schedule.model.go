...
type Schedule struct {
	...
	User_Class_History_Code  string     `form:"user_class_history_code" json:"user_class_history_code" xml:"user_class_history_code" db:"user_class_history_code"`
	...
	Planning_Start_Time      time.Time  `form:"planning_start_time" json:"planning_start_time" xml:"planning_start_time" db:"planning_start_time"`
	Planning_End_Time        time.Time  `form:"planning_end_time" json:"planning_end_time" xml:"planning_end_time" db:"planning_end_time"`
