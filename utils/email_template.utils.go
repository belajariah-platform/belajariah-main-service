                   ...
                   <table style="border-spacing:0;width:%s;background-color:transparent;margin:0;padding:20px" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr style="margin:0;padding:0">
                                ...
                                <tr style="margin:0;padding:0">
                                    <td style="margin:0;padding:0">
                                        <h5 style="line-height:1.4;color:black;font-weight:700;margin:0px 0px 10px 0px;padding:0;font-size: 14px;">Pembayaran pesanan Kelas %s dengan nomor pesanan %s BERHASIL DILAKUKAN ! Kelas siap dimulai ..
									</h5>  
                                    </td>
                                </tr>
                        </tbody>
